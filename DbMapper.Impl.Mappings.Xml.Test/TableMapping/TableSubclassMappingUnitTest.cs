...
namespace DbMapper.Impl.Mappings.Xml.Test.TableMapping
{
    ...
    class TableSubclassMappingUnitTest
    {
        ...
        public void NoName()
        {
            ...
            var ex = Assert.Throws<DocumentParseException>(() => new XmlSubClassMapping(mock.Object, xml));
        ...
        public void CheckName()
        {
            ...
            var mapping = new XmlSubClassMapping(mock.Object, xml);
        ...
        public void ClassDiscriminatorValueWithoutColumn()
        {
            ...
            var ex = Assert.Throws<DocumentParseException>(() => new XmlSubClassMapping(null, xml));
